...
const HeroGradient = () => {
  return (
    <div>
      ...
      <div className="shadow-cyanMediumShadow absolute top-[150px] left-0 -z-10 opacity-50"></div>
      <div className="shadow-orangeMediumShadow absolute top-[270px] left-0 -z-10 opacity-50"></div>
    </div>
  );
};
